...
<body>
    <div class="form-container">
        ...
        <form action="RemoveHodServlet" method="post">
            ...
            <input type="text" id="name" name="name" placeholder="Enter HOD name" required>

            <label for="gmail">Gmail:</label>
            <input type="email" id="gmail" name="gmail" placeholder="Enter HOD email" required>

            <button type="submit">Remove HOD</button>
        </form>
